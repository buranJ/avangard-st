        ...
        <div className="contacts__content">
          <form action="" className="contacts__form">
            ...
            <select name="" id="" className="contacts__form-input">
              <option value="" className="contacts__form-option">
                Тема
              </option>
              <option value="" className="contacts__form-option">
          ...
          <div className="contacts__right">
            ...
            <a className="contacts__right-link" href="tel:+996 312 98 89 58">
              +996 312 98 89 58
            </a>
            <a className="contacts__right-link" href="tel:+996 223 44 74 65">
              +996 223 44 74 65
            </a>
            <a
              className="contacts__right-link"
              href="mailto:sales@avangardstyle.kg"
            >
              sales@avangardstyle.kg
            </a>
            <a
              className="contacts__right-link"
              href="mailto:info@avangardstyle.kg"
            >
